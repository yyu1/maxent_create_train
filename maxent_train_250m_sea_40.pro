...
in_file = '/Users/yifan/work/projects/global_carbon/250m/glas/glas_sea_aggregate_2plus_30pctslp_extract.csv'
log_file = '/Volumes/Global_250m/samples/glas/train_hlorey_v3/sea/process_hlorey_sea_v3_cl40.log'
class_to_use = [40]
...
in_file = '/Users/yifan/work/projects/global_carbon/250m/glas/glas_sea_aggregate_2plus_30pctslp_extract.csv'
log_file = '/Volumes/Global_250m/samples/glas/train_hlorey_v3/sea/process_hlorey_sea_v3_cl7090100.log'
...
in_file = '/Users/yifan/work/projects/global_carbon/250m/glas/glas_sea_aggregate_2plus_30pctslp_extract.csv'
log_file = '/Volumes/Global_250m/samples/glas/train_hlorey_v3/sea/process_hlorey_sea_v3_misclass.log'
class_to_use = [14,20,30,140,150,230]
out_train_file = '/Volumes/Global_250m/samples/glas/train_hlorey_v3/sea/train_hlorey_sea_v3_clmisclass.csv'
out_valid_file = '/Volumes/Global_250m/samples/glas/train_hlorey_v3/sea/valid_hlorey_sea_v3_clmisclass.csv'
out_bin_file = '/Volumes/Global_250m/samples/glas/train_hlorey_v3/sea/bin_hlorey_sea_v3_clmisclass.csv'
create_maxent_train_proc_unmodxy, in_file, log_file, x_col, y_col, val_col, class_col, slope_col, max_slope, class_to_use, out_train_file, out_valid_file, out_bin_file, train_pct, max_bins, min_bin_width, min_bin_members, valname, coordformat, valformat, max_bin_start
